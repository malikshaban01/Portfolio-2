  ...
  return (
    <div className="relative">
      ...
      <div className="hidden lg:flex fixed left-6 bottom-0 flex-col items-center gap-6 after:content-[''] after:w-px after:h-24 after:bg-slate-600">
        <a href="https://github.com/shabanmalik" target="_blank" rel="noreferrer" aria-label="GitHub" className="text-slate-400 hover:text-teal-400 hover:-translate-y-1 transition">
        ...
        <a href="https://linkedin.com/in/shabanmalik" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="text-slate-400 hover:text-teal-400 hover:-translate-y-1 transition">
